...
<a href="http://careview.in/partner.php" class="default-btn banner_btn3" style="font-weight:bold; margin-top:20px !important; ">PARTNER WITH US </a>
       ...
       <!--   </div>    -->
		...
		<!-- End Hero Slider Area -->
		 ...
		 <div class="section vertical-scrolling" id="section1" style="background:#d6d6d6;">
                
                
                <section style="height:100vh;">
			<div class="container-1">
				<!--<div class="section-title">-->
				<!--	<br><br><h2>OUR PRODUCTS</h2>-->
				<!--	<p style="font-size:15px;">Care View offers a complete range of genuine Medical & Healthcare Products made with care and quality to make everyone “BE LIFE READY”. </p>-->
				<!--</div>	-->
				<div class="sdp_outer" style="position:relative;"><!-- new code -->
					<div class="w3-content w3-section" style="max-width:100%">
					 <a href="http://careview.in/n95-mask.php#CV-1221"><img class="mySlides" src="img/product/01.png" style="width:100%"></a>
					 <a href="http://careview.in/n95-mask.php#CV-1221V"><img class="mySlides" src="img/product/02.png" style="width:100%"></a>
				     <a href="http://careview.in/n95-mask.php#CV-1221H"><img class="mySlides" src="img/product/03.png" style="width:100%"></a>
			        <a href="http://careview.in/n95-mask.php#CV-1221HV"> <img class="mySlides" src="img/product/04.png" style="width:100%"></a>
			         <a href="http://careview.in/3ply-mask.php#CV-2992"><img class="mySlides" src="img/product/05.png" style="width:100%"></a>
			         <a href="http://careview.in/3ply-mask.php#CV-2992M"><img class="mySlides" src="img/product/06.png" style="width:100%"></a>
...
//   	  prevArrow: '<span class="product-showcase-carousel-controls product-showcase-carousel-controls--left"><img src="..//img/arrow.svg" /></span>'     
		...
		// new code 
			$("ul.slider_dots li").removeClass('red');
			$( "ul.slider_dots li:nth-child("+myIndex+")" ).addClass('red');
			// new code ends 
		...
		$(document).ready(function(){
				$('.slider_dots li').click(function(){
					//alert('hi');
					$('.slider_dots li').removeClass('red');
					$(this).addClass('red');
					var newIndex = $(this).attr('id');
					//alert(newIndex);
					$('.w3-section img').hide();
					$('.w3-section img:nth-child('+newIndex+')').show();
				})
